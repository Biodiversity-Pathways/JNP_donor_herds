...
#                                                                                            bs = "re") + is.Feed.minus1 + pen.effect + s(r.minus1, r.minus2, 
#                                                                                                                                         k = 4)
# 
# Parametric coefficients:
#   Estimate Std. Error t value Pr(>|t|)    
# (Intercept)           -0.049996   0.665504  -0.075 0.940116    
# is.WolfReduce.minus1   0.068144   0.018388   3.706 0.000211 ***
#   is.MooseReduce.minus1 -0.006367   0.016264  -0.391 0.695450    
# is.Feed.minus1         0.222247   0.003269  67.986  < 2e-16 ***
#   pen.effect             3.411757   0.081735  41.742  < 2e-16 ***
#   ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
# Approximate significance of smooth terms:
#   edf Ref.df         F p-value    
# s(herd)                       31.00     31 1.584e+05  <2e-16 ***
#   s(herd,is.WolfReduce.minus1)  11.99     12 7.469e+09  <2e-16 ***
#   s(herd,is.MooseReduce.minus1)  1.99      2 3.145e+10  <2e-16 ***
#   s(r.minus1,r.minus2)           3.00      3 1.460e+03  <2e-16 ***
#   ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
# R-sq.(adj) =  0.166   Deviance explained = 16.6%
# GCV = 0.010215  Scale est. = 0.010214  n = 735000
...
# Approximate significance of smooth terms:
#   edf  Ref.df      F p-value    
# s(gam_1.pred)             2.398   2.696  33.68  <2e-16 ***
#   s(herd,gam_1.pred)       45.779  46.784  53.37  <2e-16 ***
#   s(herd,year,gam_1.pred) 375.197 381.093 340.08  <2e-16 ***
#   s(r.minus1,r.minus2)      2.991   3.000 925.12  <2e-16 ***
#   ---
#   Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
# Rank: 840/886
# R-sq.(adj) =  0.616   Deviance explained = 61.9%
# GCV = 0.0060187  Scale est. = 0.0060057  n = 198000
...
#         ylim = c(0, 10000), ylab = "Adult Females", xlab = "Year")
...
write.csv(results, 'Data/results_noDD_remove6in2025_remove6in2026_20240709.csv')
